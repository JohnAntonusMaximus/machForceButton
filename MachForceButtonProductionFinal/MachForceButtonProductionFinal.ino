...
void setup(void) {
    ...
    wifiManager.setConfigPortalTimeout(300); // This will determine when the relay shuts off
    bool WiFiConnected = wifiManager.autoConnect("MachForce","simians1228"); // checkMillis needs to put in this function
...
void StageTwo(){
    ...
    customerDetailPage += "<label for=\"customerName\" class=\"col-xs-4 col-form-label\" style=\"line-height: 15px; width: 22%; padding-top: 10px;\">Account Name </label>";
    ...
    customerDetailPage += "</div>";
    customerDetailPage += "<div class=\"form-group row\">";
    customerDetailPage += "<label for=\"cAccount\" class=\"col-xs-4 col-form-label\" style=\"line-height: 15px; width: 22%; padding-top: 10px;\">Account # OR Location </label>";
    customerDetailPage += "<div class=\"col-xs-4\">";
    ...
    customerDetailPage += "</div>";
    customerDetailPage += "<div class=\"form-group row\">";
    customerDetailPage += "<label for=\"vAccount\" class=\"col-xs-4 col-form-label\" style=\"line-height: 15px; width: 22%; padding-top: 10px;\">MachForce Account # </label>";
    customerDetailPage += "<div class=\"col-xs-4\">";
    ...
    customerDetailPage += "</div>";
    customerDetailPage += "<div class=\"form-group row\">";
    customerDetailPage += "<label for=\"tenantMode\" class=\"col-xs-4 col-form-label\" style=\"line-height: 15px; width: 22%; padding-top: 10px; padding-top: 10px;\">Tenant Mode? </label>";
    customerDetailPage += "<div class=\"col-xs-4\">";
    customerDetailPage += "<input class=\"form-control\" type=\"checkbox\" id=\"tenantMode\" name=\"tenantMode\" maxlength=\"20\">";
    customerDetailPage += "</div>";
    customerDetailPage += "</div>";
...
void handle_form() { 
  ...
  String tenantMode         = server.arg("tenantMode"); // evaluates to "on" if checkbox is checked
  ...
  customerDetails += "\"tenantMode\": \""       + tenantMode                    + "\"";
  customerDetails += "}";
